...
| `!full` | `/full`, `full analysis` | Full Report | Draft | Produce a full research packet combining business, financials, thesis, risk, scoring, and classification. | `skills/stock-analysis/full/SKILL.md` | Not created yet | Not created yet | Required | Required | Required | Yes |
