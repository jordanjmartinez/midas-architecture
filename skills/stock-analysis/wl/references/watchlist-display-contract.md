...
Use this when maintaining the `!wl`, `!watchlist`, or `!list` command family.

Session-learned preferences:

- Treat `!wl`, `!watchlist`, and `!list` as full alias families for the same watchlist command behavior.
